...
*/
--fixed:
INSERT INTO Invenory (articleCode, barcode, sizes, CurrentBasePrice, CurrentSalePrice, consignment, consignmentRp, qty, status) VALUES ('AGA-PI0020','2016I00080','XL',130000,200000,30,70000,0,0);
...
*/
--fixed:
INSERT INTO Invenory (articleCode, barcode, sizes, CurrentBasePrice, CurrentSalePrice, consignment, consignmentRp, qty, status) VALUES ('AR.REC-RJ002','20ARRJ0367','32',237250,365000,0,127750,0,0);
...
*/
--fixed:
INSERT INTO Invenory (articleCode, barcode, sizes, CurrentBasePrice, CurrentSalePrice, consignment, consignmentRp, qty, status) VALUES ('BSC.AR-QL0010','00ARQL0067','M',94500,135000,0,40500,0,0);
...
*/
--fixed:
INSERT INTO Invenory (articleCode, barcode, sizes, CurrentBasePrice, CurrentSalePrice, consignment, consignmentRp, qty, status) VALUES ('ESH.AR-SE0006','00ARSE0021','S',44000,135000,0,40500,3,0);
...
*/
--fixed:
INSERT INTO CashierPayment_temp (id, noTrans, paidType, cardInit, cardName, cardNumber, totalpaid, MachineName, CompanyCharge, CustomerCharge, ReffNo, ProgressiveDisc) VALUES (61785,'01SCS19E070078','CASH','-','-','-',94500,'-',0,0,'-',0);
...
*/
--fixed:
INSERT INTO CashierPayment_temp (id, noTrans, paidType, cardInit, cardName, cardNumber, totalpaid, MachineName, CompanyCharge, CustomerCharge, ReffNo, ProgressiveDisc) VALUES (68275,'01SCS19E310181','CASH','-','-','-',135000,'-',0,0,'-',0);
